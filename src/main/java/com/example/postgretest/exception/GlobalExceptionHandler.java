...
import com.example.postgretest.exception.basic.ResponseCode;
...
public class GlobalExceptionHandler {
    ...
    public APIResponse processApiException(
            ...
            BusinessException e) throws JsonProcessingException {
        //创建Jackson对象 ObjectMapper
        ObjectMapper mapper=new ObjectMapper();
        log.info("服务器业务提示错误：{}, 参数：{}", request.getRequestURI(), mapper.writeValueAsString(request.getParameterMap()));
